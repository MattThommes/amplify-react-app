...
function App()
{
    ...
    const fetchBackend = useCallback(async (path) => {
        // The API name 'AmplifyReactAppApi' is defined in the aws-exports.js file
        // that's generated by the Amplify CLI.
        // The path is derived from the current page route.
        const apiName = 'AmplifyReactAppApi';
        const apiPath = `/${path}`;
